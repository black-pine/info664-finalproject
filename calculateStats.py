...
# This file calculates and aggregates statistics based on "comicsData.csv"
# This file generates "issueTypeData.csv," "monthlyData.csv," "publisherData.csv," "reorderData.csv," and "seriesData.csv" saved to the same directory as this file
...
with open('comicsData.csv', 'r') as comics:
	...
	for row in reader:
		# calculate estimated revenue from issue price and estimated unit sales
...
# create and save data to "publisherData.csv"
...
# create and save data to "issueTypeData.csv"
...
# create and save data to "seriesData.csv"
...
# create and save data to "reorderData.csv"
...
# create and save data to "monthlyData.csv"
